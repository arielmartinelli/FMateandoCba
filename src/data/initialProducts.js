// Catálogo inicial de F Mateando CBA (64 productos).
// `slug` es el identificador estable y legible de cada producto: se usa como
// clave de conflicto al sembrar/actualizar en Supabase, de modo que sembrar dos
// veces NO duplica filas. El `id` real lo genera Supabase (UUID).
...
export const INITIAL_PRODUCT_COUNT = INITIAL_PRODUCTS.length;
